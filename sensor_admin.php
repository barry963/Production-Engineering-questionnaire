...
//-------------------------------------- _Lu
/* 
		    <tr><td><input class='CustText' name='userid'.$i type='text' size='3' value='$field2_name' readonly/></td>
			<td><input class='CustText' name='questid'.$i type='text' size='3' value='$field4_name' readonly/></td>";
  			<td><form><input  class='UnitType' name='questtypeid'.$i type='checkbox' checked='checked' value='1' ></form></td>
			<td><input class='CustText' name='questid'.$i size='50' style='font-weight:bold' value='$field3_name'/></td>
...
<form name="companyName" method="post" action="SR" class="margin">
		...
		<td><b>2, Sensor and Response Form Administrator Page</b>
				<ul>
		  			<li><b>Form #1</b></li>
		  			<li><a href='sensor2_admin.php'><b>Form #2</b></a></li>
		  		</ul>
		</td>
		</tr>
		</table>
...
<form method='POST' action='sensor_admin.php' class='margin'>
...
echo"</tr>";
	...
	<input  size="1" type="hidden" name="tablerownum" readonly/>
		<input  size="1" type="hidden" name="tablebasename" value="SRForm1" readonly/>	
